  ...
  module OperatingSystems
    ...
    module Darwin
      ...
      IOS = {
        ...
        '21.5.0' => '15.5',
        '21.6.0' => '15.6',   # also 15.6.1, 15.7 and 15.7.1
        '22.0.0' => '16.0.x',
        '22.1.0' => '16.1',
        '22.2.0' => '16.2'
      }.freeze
      ...
      # A mapping of Darwin kernel versions to tvOS versions
      TV_OS = {
        '15.4.0' => '9.2',
        '16.0.0' => '10.0',
        '16.1.0' => '10.0.1',
        '16.3.0' => '10.1',   # also 10.1.1
        '16.5.0' => '10.2',
        '16.6.0' => '10.2.1',
        '16.7.0' => '10.2.2',
        '17.0.0' => '11.0',
        '17.2.0' => '11.1',
        '17.3.0' => '11.2',   # also 11.2.1
        '17.4.0' => '11.2.5', # also 11.2.6
        '17.5.0' => '11.3',   # also 11.4 beta
        '17.6.0' => '11.4',
        '17.7.0' => '11.4.1',
        '18.0.0' => '12.0',   # also 12.0.1
        '18.2.0' => '12.1',   # also 12.1.1, 12.1.2
        '18.5.0' => '12.2',   # also 12.2.1
        '18.6.0' => '12.3',   # also 12.4 beta
        '18.7.0' => '12.4',   # also 12.4.1
        '19.0.0' => '13.0',   # also 13.2
        '19.2.0' => '13.3',
        '19.3.0' => '13.3.1',
        '19.4.0' => '13.4',
        '19.5.0' => '13.4.5', # also 13.4.6
        '19.6.0' => '13.4.6',
        '20.0.0' => '14.0',
        '20.1.0' => '14.2',
        '20.2.0' => '14.3',
